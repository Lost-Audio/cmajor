...
struct EmbeddedWebAssets
{
    ...
    static constexpr std::array files =
    {
        ...
        File { "cmaj-generic-patch-view.js", std::string_view (cmajgenericpatchview_js, 13192) },
        ...
        File { "cmaj-patch-connection.js", std::string_view (cmajpatchconnection_js, 16587) },
        ...
        File { "cmaj-types.d.ts", std::string_view (cmajtypes_d_ts, 2080) },
